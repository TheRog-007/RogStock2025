...
namespace RogStock2025.Modules
{
    ...
    {                                                //data source = server name
        ...
        public static void PopulateComboBoxes(ComboBox CMBTemp, string strTable)
        {
            /*
              Created 17/02/2025 By Roger Williams

              Populates the comboboxes with table values
            ...
            */
            ...
            SqlConnection ADOConn; // = new SqlConnection(CNST_STR_ODBC);
            SqlCommand SQLCmd;
            SqlDataReader SQLRead;
            ...
            try
            {
                using (ADOConn = new SqlConnection(Modules.clsData.CNST_STR_ODBC))
                {
                    ...
                    while (SQLRead.Read())
                    {
                        //if (strTable == CNST_STR_LOGINCURRENT)
                        // {
                        //     CMBTemp.Items.Add(SQLRead[])
                        // }
